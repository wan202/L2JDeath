...
public class Npc extends Creature
{
	...
	/**
	 * Constructor of L2Npc (use Character constructor).<BR>
	 * <BR>
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Call the Character constructor to set the _template of the Character (copy skills from template to object and link _calculators to NPC_STD_CALCULATOR)</li>
	 * <li>Set the name of the Character</li>
	...
	/**
	 * Send a packet NpcInfo with state of abnormal effect to all Player in the _KnownPlayers of the L2Npc.
	 */
	@Override
	public void updateAbnormalEffect()
	{
		// Send NpcInfo with state of abnormal effect to all Player in the _KnownPlayers of the L2Npc
	...
	/**
	 * Set the Title of the Character. Concatens it if length > 16.
	...
	public void showChatWindow(Player player, int val)
	{
		...
		{
			if (!Config.KARMA_PLAYER_CAN_SHOP && this instanceof Merchant)
			{
			...
			else if (!Config.KARMA_PLAYER_CAN_SHOP && this instanceof Fisherman)
			{
