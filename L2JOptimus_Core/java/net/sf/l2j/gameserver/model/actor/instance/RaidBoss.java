...
public class RaidBoss extends Monster
{
	 ...
	 * <ul>
	 * <li>Call the Character constructor to set the _template of the L2RaidBossInstance (copy skills from template to object and link _calculators to NPC_STD_CALCULATOR)</li>
