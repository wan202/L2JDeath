...
public class Monster extends Attackable
{
	...
	/**
	 * Constructor of Monster (use Character and Npc constructor).
	 * <ul>
	 * <li>Call the Character constructor to set the _template of the Monster (copy skills from template to object and link _calculators to NPC_STD_CALCULATOR)</li>
