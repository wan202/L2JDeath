...
public class Attackable extends Npc
{
	 ...
	 * <li>Kill the Npc (the corpse disappeared after 7 seconds)</li>
	 * </ul>
	 ...
	 * <ul>
	 * <li>Get the Player owner of the Summon (if necessary) and L2Party in progress</li>
	 ...
	 * <BR>
	 * This is located here because L2Monster and L2FriendlyMob both extend this class. The other non-pc instances extend either Npc or Monster.
	 */
	@Override
	...
	/**
	 * Add damage and hate to the attacker AggroInfo of the Attackable _aggroList.
	 * @param attacker The Character that gave damages to this Attackable
	...
	/**
	 * Manage Base & Quests drops of Attackable (called by calculateRewards).
	 * <ul>
	 * <li>Get all possible drops of this Attackable from L2NpcTemplate and add it Quest drops</li>
	 ...
	 * <li>If the autoLoot mode is actif and if the Character that has killed the Attackable is a Player, give this or these Item(s) to the Player that has killed the Attackable</li>
	 * <li>If the autoLoot mode isn't actif or if the Character that has killed the Attackable is not a Player, add this or these Item(s) in the world as a visible object at the position where mob was last</li>
	 * </ul>
	...
	/**
	 * @return true if a Dwarf used Spoil on the Attackable.
	 */
	...
	{
		// If the Character attacker isn't already in the _absorbersList of this Attackable, add it
	...
	/**
	 * Calculate the Experience and SP to distribute to attacker (Player, Summon or L2Party) of the Attackable.
	 * @param diff The difference of level between attacker (Player, Summon or L2Party) and the Attackable
	 * @param damage The damages given by the attacker (Player, Summon or L2Party)
